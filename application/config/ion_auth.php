 ...
 */
$config['site_title']                 = "SNMPN POLBAN ".date('Y')." e-mail Automation System";       // Site Title, example.com 
$config['admin_email']                = "noreply@polban.ac.id"; // Admin Email, admin@example.com
